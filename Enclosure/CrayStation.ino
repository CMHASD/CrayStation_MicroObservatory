...
#pragma endregion
#pragma region NOTES
// Started code on 13 Oct 2024

// Hand box:      https://uk.rs-online.com/web/p/general-purpose-enclosures/2291642?searchId=00827946-2c73-4fd1-bb06-8dcc41f0faa3&gb=s
// Rain detector: https://www.firstlightoptics.com/astronomy-cables-leads-accessories/lunatico-hydreon-rg-9-rain-sensor.html
...
/* For the Arduino Pro Micro
  ...
  =================
                            ...
                            +-------+
Rain          INT3  TX  D1  o       o RAW         (Vin <=12V)
Rain          INT2  RX  D0  o       o GND
                        GND o       o RST         (GND to activate)
                        GND o       o VCC         (5V)
I2C           INT1  SDA D2  o       o D21   A3    Servo
I2C           INT0  SCL D3~ o       o D20   A2    Ammeter
Motor Dir           A6  D4  o       o D19   A1    Voltage Sensor Solar Panel
Motor PWM               D5~ o       o D18   A0    Voltage Sensor 12V battery
LED's               A7  D6~ o       o D15   SCLK  Open Switch
HandBox                 D7  o       o D14   MISO  Closed Switch
Buzzer              A8  D8~ o       o D16   MOSI  RPi Power       L9110S Dual-Channel H-bridge
RG-9 Rain           A9  D9~ o       o D10~  A10   Webcam Power    L9110S Dual-Channel H-bridge
                            +-------+

L9110S Dual-Channel H-bridge is used to drive enclosure motor, but can be used to turn on the RPi and Webcam

I2C I/O expansion board (PCF8575) - 16 pins
...
I2C Thermometer, barometer, humidity
Rain Detector requires 3.3V to power it, so Arduino's TXD must work at 3.3V

#define MTR_DIR       4
#define MTR_PWM       5
#define LEDS          6           // Power for the enclosure LEDs
#define HANDBOX       7
#define BUZZER        8
#define RAIN_RG9      9
#define WEBCAM        10          // Power for the Webcam
#define BOX_OPEN_SW   15
#define BOX_CLOSED_SW 14
#define RPI_POWER     16
#define SOLAR         A0
#define BATTERY       A1
#define AMMETER       A2
